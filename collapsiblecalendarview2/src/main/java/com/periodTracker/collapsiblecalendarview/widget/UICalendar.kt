...
import com.periodTracker.collapsiblecalendarview.view.LockScrollView
...
abstract class UICalendar constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0) : ScrollView(context, attrs, defStyleAttr) {
    ...
    protected var mTxtCurrentDate: TextView
    ...
    init {
        ...
        mTxtCurrentDate = rootView.findViewById(R.id.tvCurrentDate)
