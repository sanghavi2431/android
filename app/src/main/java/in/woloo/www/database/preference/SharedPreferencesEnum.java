...
public enum SharedPreferencesEnum {
    ...
    GLOBAL_SEARCH_STORE_ID {
        ...
        @Override
        public String getPreferenceKey() {
            return "POWDER_ROOM_CODE";
        }
    },POWDER_ROOM_AMOUNT {
        @Override
        public String getPreferenceKey() {
            return "POWDER_ROOM_AMOUNT";
        }
    },USER_PROFILE_EXPIRY_DATE {
        @Override
        public String getPreferenceKey() {
            return "USER_PROFILE_EXPIRY_DATE";
        }
    }, USER_PROFILE_SUBSCRIPTION_NAME {
        @Override
        public String getPreferenceKey() {
            return "USER_PROFILE_SUBSCRIPTION_NAME";
        }
    },
    TRANSPORT_MODE {
        @Override
    ...
    FIRST_TIME_APP_LAUNCHED_LOO{
        @Override
        public String getPreferenceKey() {
            return "FIRST_TIME_APP_LAUNCHED_LOO";
        }
    }, APP_LAUNCHED_ONE_TIME_LOO {
        @Override
        public String getPreferenceKey() {
            return "APP_LAUNCHED_ONE_TIME_LOO";
        }
