...
public class ImportContacts
{
    ...
    public ArrayList<Contact> getMobileContacts()
    {
        ...
        if (!flag)
        {
            Logger.i(Utilities.TAG_LIB, "Missing permission READ_CONTACTS");
        ...
        if (contacts.isEmpty())
        {
            Logger.i(Utilities.TAG_LIB, "Lib: No contacts found");
        }
    ...
    public synchronized boolean hasPermission(String permission)
    {
        ...
        for (int i = 0; i < permissionsArray.length; i++)
        {
            ...
            {
                Logger.w(Utilities.TAG_LIB, permission + " permission is missing.");
                return false;
            }
            else
            {
