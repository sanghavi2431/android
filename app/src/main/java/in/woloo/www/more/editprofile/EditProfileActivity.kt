...
class EditProfileActivity : AppCompatActivity(), EditProfileView, TextWatcher,
    ...
    var tvTitleDesscription: TextView? = null

    @JvmField
    @BindView(R.id.screen_image)
    var tvHeaderImage: ImageView? = null
    ...
    private val resultLauncher = registerForActivityResult(ActivityResultContracts.StartActivityForResult()) { result ->
        if (result.resultCode == Activity.RESULT_OK) {
            result.data?.let { data ->
                ...
                etPincode!!.setText(newZipCode.toString())
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        items = resources.getStringArray(R.array.gender_array).toList()

        tvHeaderImage!!.setImageResource(R.drawable.edit_header_icon)
        tvTitleDesscription!!.setText(R.string.edit_profile_desc)

        etCity!!.setOnClickListener(
            { v: View? ->
                val intent = Intent(this, SerachLayoutForOnRouteFragment::class.java)
                intent.putExtra("EXTRA_KEY", "profile_address")
    ...
    private fun initViews() {
        try {
            ...
            val viewProfileResponse: UserProfile =
                WolooApplication.instance!!.profileResponseKotlin!!
            ...
            try {
                ...
                if(viewProfileResponse.profile!!.gender!!.isNotEmpty() || !viewProfileResponse.profile!!.gender.toString().equals("null" , ignoreCase = true) || viewProfileResponse.profile!!.gender.toString() != "") {
            ...
            tvSubmit!!.setOnClickListener { v: View? ->
                if (isValid) {
                    try {
                        if (items.any { it.equals(gender, ignoreCase = true) }) {
          ...
          dob = new SimpleDateFormat(outputPattern).format(date);
                            ...
                            Toast.makeText(this, "Please select gender from drop down", Toast.LENGTH_SHORT).show()
                        }
                    } catch (e: Exception) {
