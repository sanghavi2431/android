        ...
        try {
            if (coin_History[position].type == AppConstants.NAVIGATION_REWARDS) {
                ...
                Glide.with(context)
                    ...
                    .into(viewHolder.ivWolooStore!!)
            }else if (coin_History[position].type == AppConstants.MANUAL_CREDITS) {
                viewHolder.tvCreditMsg!!.text = "manual credits"
                Glide.with(context)
                    .load(R.drawable.manual_credit)
                    .into(viewHolder.ivWolooStore!!)
            }
            else if (coin_History[position].type == AppConstants.RATE_TOILET_CLICK) {
                viewHolder.tvCreditMsg!!.text = "Rate Toilet"
                Glide.with(context)
                    .load(R.drawable.manual_credit)
                    .into(viewHolder.ivWolooStore!!)
            }
            else if (coin_History[position].type == AppConstants.HOST_DETAILS_CLICK) {
                viewHolder.tvCreditMsg!!.text = "Visited Host Details"
                Glide.with(context)
                    .load(R.drawable.manual_credit)
                    .into(viewHolder.ivWolooStore!!)
            }
            else if (coin_History[position].type == AppConstants.TAKE_ME_HERE_CLICK) {
                viewHolder.tvCreditMsg!!.text = "Take me Here"
                Glide.with(context)
                    .load(R.drawable.manual_credit)
                    .into(viewHolder.ivWolooStore!!)
            }
            else if (coin_History[position].type == AppConstants.NO_WOLOO_FOUND_CLICK) {
                viewHolder.tvCreditMsg!!.text = "No Woloo Found"
                Glide.with(context)
                    .load(R.drawable.manual_credit)
                    .into(viewHolder.ivWolooStore!!)
            }
            else if (coin_History[position].type == AppConstants.SET_PERIOD_TRACKER_CLICK) {
                viewHolder.tvCreditMsg!!.text = "Set Period Date"
                Glide.with(context)
                    .load(R.drawable.manual_credit)
                    .into(viewHolder.ivWolooStore!!)
            }
            else if (coin_History[position].type == AppConstants.SET_THIRST_REMINDER_CLICK) {
                viewHolder.tvCreditMsg!!.text = "Set Thirst Reminder"
                Glide.with(context)
                    .load(R.drawable.manual_credit)
                    .into(viewHolder.ivWolooStore!!)
            }
            else if (coin_History[position].type == AppConstants.WOLOO_SUBSCRIPTION_POINTS_CLICK) {
                viewHolder.tvCreditMsg!!.text = "Subscribed to Woloo"
                Glide.with(context)
                    .load(R.drawable.manual_credit)
                    .into(viewHolder.ivWolooStore!!)
            }
