...
abstract class ShopBlogsItemModel  : EpoxyModelWithHolder<ShopBlogsItemModel.Holder>() {
    ...
    override fun bind(holder: ShopBlogsItemModel.Holder) {
        ...
        ImageUtil.loadImageBlogs(
            ...
            holder.ivBlogItem!!,
            BuildConfig.BASE_URL + AppConstants.DEFAULT_BASE_URL_FOR_BLOG_IMAGE + blog!!.mainImage
        )
        if (isFavourite > 0) {
        ...
        if (isBlogRead > 0) {
            ...
            holder.rlBlogPoints?.backgroundTintList =
                ContextCompat.getColorStateList(holder.rlBlogPoints!!.context, R.color.sheildcolor)
        }
