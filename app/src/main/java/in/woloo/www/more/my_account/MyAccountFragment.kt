...
class MyAccountFragment : Fragment(), MyAccountView {
    ...
    private fun initViews() {
        ...
        try {
            ...
            Glide.with(this)
                .load(R.drawable.piggi_anim) // your gif in res/drawable
                .into(img_logo!!)
                ...
                try {
                    if (userCoinsResponse != null) {
                        if (userCoinsResponse.data != null && userCoinsResponse.data != null) {
                            tvWolooPoints!!.setText(userCoinsResponse!!.data!!.totalCoins.toString() + " Points")
                            tvWolooMoney!!.text =
                                "₹ " + userCoinsResponse!!.data!!.giftCoins // + " Cards"
                        }
                    } else {
        ...
        try {
            if (userCoinsResponse != null) {
                ...
                if (userCoinsResponse.data != null && userCoinsResponse.data!!
                    ...
                    tvWolooMoney!!.text =
                        "₹ " + userCoinsResponse.data!!.giftCoins + " in Gift Cards"
                }
            }
        } catch (ex: Exception) {
            CommonUtils.printStackTrace(ex)
