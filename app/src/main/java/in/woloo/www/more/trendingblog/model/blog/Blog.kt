...
class Blog {
    ...
    @Expose
    var mainImage: ArrayList<String>? = null

    @SerializedName("main_video")
    @Expose
    var videoUrl: ArrayList<String>? = null

    @SerializedName("video_thumbnail")
    @Expose
    var videoThumbnil: ArrayList<String>? = null
    ...
    @SerializedName("main_image_count")
    var mainImageCount: Int? = null


}

sealed class MediaItemBlog {
    data class Image(val url: String) : MediaItemBlog()
    data class Video(val url: String) : MediaItemBlog()
}
