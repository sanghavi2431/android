...
@EpoxyModelClass(layout = R.layout.home_shop_blog_two_adapter)
abstract class ShopBlogsItemModelTwo  : EpoxyModelWithHolder<ShopBlogsItemModelTwo.Holder>() {
    @EpoxyAttribute
    ...
    override fun bind(holder: ShopBlogsItemModelTwo.Holder) {
        try {
            ...
            if(blog!!.videoUrl.isNullOrEmpty()) {
                ImageUtil.loadImageBlogs(
                    holder.ivBlogItemOne?.context!!,
                    holder.ivBlogItemOne!!,
                ...
                ImageUtil.loadImageBlogs(
                    holder.ivBlogItemTwo?.context!!,
                    holder.ivBlogItemTwo!!,
                    BuildConfig.NODE_API_URL + (blog!!.mainImage?.get(
                        1
                    ))
                )
            ...
            holder.ivBlogItemOne?.setOnClickListener { view: View? ->
                onClickBlogViewItems!!.onClickBlogItem(
                    blog!!,
                    itemPosition
                )
            }
            holder.ivBlogItemTwo?.setOnClickListener { view: View? ->
                onClickBlogViewItems!!.onClickBlogItem(
                    blog!!,
                    itemPosition
                )
    ...
    class Holder : BaseEpoxyHolder() {
        @JvmField
        @BindView(R.id.blogImgTwoTwo)
        var ivBlogItemTwo: ImageView?= null

        @JvmField
        @BindView(R.id.blogImgTwoOne)
        var ivBlogItemOne: ImageView?= null
