...
@EpoxyModelClass(layout = R.layout.home_shop_blog_three_adapter)
abstract class ShopBlogsItemModelThree  : EpoxyModelWithHolder<ShopBlogsItemModelThree.Holder>() {
    @EpoxyAttribute
    ...
    override fun bind(holder: ShopBlogsItemModelThree.Holder) {
        try {
            ...
            if(blog!!.videoUrl.isNullOrEmpty()) {
            ImageUtil.loadImageBlogs(
                holder.ivBlogImgThree?.context!!,
                holder.ivBlogImgThree!!,
                BuildConfig.NODE_API_URL + (blog!!.mainImage?.get(
                    0
                ))
            )
            ImageUtil.loadImageBlogs(
                holder.ivBlogImgThreeOne?.context!!,
                holder.ivBlogImgThreeOne!!,
                BuildConfig.NODE_API_URL + (blog!!.mainImage?.get(
                    1
                ))
            )
            ImageUtil.loadImageBlogs(
                holder.ivBlogImgThreeTwo?.context!!,
                holder.ivBlogImgThreeTwo!!,
                BuildConfig.NODE_API_URL + (blog!!.mainImage?.get(
                    2
                ))
            )
            }
            else if(blog!!.videoUrl!!.size == 1)
            {
                ImageUtil.loadImageBlogs(
                    holder.ivBlogImgThree?.context!!,
                    holder.ivBlogImgThree!!,
                     (blog!!.videoThumbnil?.get(
                        0
                    ))
                )
            ...
            holder.ivBlogImgThree?.setOnClickListener { view: View? ->
                onClickBlogViewItems!!.onClickBlogItem(
                    blog!!,
                    itemPosition
                )
            }
            holder.ivBlogImgThreeOne?.setOnClickListener { view: View? ->
                onClickBlogViewItems!!.onClickBlogItem(
                    blog!!,
                    itemPosition
                )
            }
            holder.ivBlogImgThreeTwo?.setOnClickListener { view: View? ->
                onClickBlogViewItems!!.onClickBlogItem(
                    blog!!,
                    itemPosition
                )
    ...
    class Holder : BaseEpoxyHolder() {
        @JvmField
        @BindView(R.id.blogImgThree)
        var ivBlogImgThree: ImageView?= null

        @JvmField
        @BindView(R.id.blogImgThreeOne)
        var ivBlogImgThreeOne: ImageView?= null

        @JvmField
        @BindView(R.id.blogImgThreeTwo)
        var ivBlogImgThreeTwo: ImageView?= null
