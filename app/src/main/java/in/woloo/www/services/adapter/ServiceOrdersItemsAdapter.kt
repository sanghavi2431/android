...
import `in`.woloo.www.services.screens.ServicesDisplayOrderDetails
...
class ServiceOrdersItemsAdapter (private val context: FragmentActivity,
                                 private val items: List<ItemsListDataOrderSet>,
                                 private val order : OrdersListData,
                                 private val fragmentManager: FragmentManager
) :
    RecyclerView.Adapter<ServiceOrdersItemsAdapter.ViewHolder>() {

    lateinit var binding: OrderDetailsItemsListItemBinding
    lateinit var productId : String
    lateinit var productName : String
    var ratingsGiven : Int = 3
    var cartItemsCustomAdapter : ServiceDateTimeOfOrderAdapter? = null
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        try {
            ...
            cartItemsCustomAdapter =
                ServiceDateTimeOfOrderAdapter(context, items, item.metadata!!.servieceDataResponse!! ,  position)
            ...
            holder.binding.checkStatusLayout.setOnClickListener {
                ...
                val intent = Intent(context, ServicesDisplayOrderDetails::class.java)
