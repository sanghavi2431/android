...
class ServicesProductImageRecylcerAdapter (private val context: Activity,
...
) : RecyclerView.Adapter<ServicesProductImageRecylcerAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.binding.heartImage.setOnClickListener{
            if(!isWishlisted)
            {
                ...
                servicesViewModel.addWishListItem(request)
                binding.heartImage.setImageResource(R.drawable.favorite_blogs_icon)
            }
            else{

                binding.heartImage.setImageResource(R.drawable.like_blog)
                servicesViewModel.deleteWishListItem(wishlistItemId)
            }
