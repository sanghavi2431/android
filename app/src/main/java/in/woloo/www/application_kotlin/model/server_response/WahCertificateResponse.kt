...
class WahCertificateResponse {
    ...
    @SerializedName("woloo")
    var wolooObject: WolooResponseCreatedForWah? = null

    @SerializedName("status")
    var statusForPopup: Int? = null

}

class WolooResponseCreatedForWah{
