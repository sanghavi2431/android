    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.parentView.setOnClickListener { view: View? ->
            ...
            if (category.isSelected) {
                holder.cardRelative.setBackgroundResource(R.drawable.interested_topics_selected)
            } else {
                holder.cardRelative.setBackgroundResource(R.drawable.new_button_background_square)
            }
        }
        if (category.isSelected) {
            holder.cardRelative.setBackgroundResource(R.drawable.interested_topics_selected)
