...
class NearByStoreResponse {
    ...
    class Data {
        ...
        @JvmField
        @SerializedName("woloo_type")
        @Expose
        var woloo_type: String? = null

        @JvmField
        @SerializedName("distanceByWalk")
        @Expose
        var distanceByWalk: String? = null

        @JvmField
        @SerializedName("timeByWalk")
        @Expose
        var timeByWalk: String? = null

        @JvmField
        @SerializedName("distanceByBike")
        @Expose
        var distanceByBike: String? = null

        @JvmField
        @SerializedName("timeByBike")
        @Expose
        var timeByBike: String? = null

        @JvmField
        @SerializedName("distanceByCar")
        @Expose
        var distanceByCar: String? = null

        @JvmField
        @SerializedName("timeByCar")
        @Expose
        var timeByCar: String? = null
