...
//                    Logger.v("Pn data", new Gson().toJson(bundleExtra));
                    ...
                    i("DeeplinkReceiver", "Deeplink: $deepLinkvalue")
                    ...
                    v("DeeplinkReceiver", "does not have deeplink path.")
                }
                ...
                if (bundleExtra.containsKey(SMTBundleKeys.SMT_BUNDLE_KEY_CLICK_CUSTOM_PAYLOAD)) {
                    ...
                    i(
                        "DeeplinkReceiver",
                        "Custom Payload: $customPayloadvalue"
                    )
                } else {
                    v("DeeplinkReceiver", "does not have custom payload.")
                }
            }
        }
    }
    ...
    companion object {
        var DEEPLINK_KEY: String = "deeplink"
    }
}
