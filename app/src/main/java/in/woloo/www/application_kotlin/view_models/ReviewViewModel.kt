...
class ReviewViewModel  : BaseViewModel(){
    ...
    fun rateToiletAddReview(userRating:Int,reviewDescription:String, name:String , address:String ,city:String , lat:String , lng:String , pincode:String) {
        updateProgress(true)
        val request  = RateReviiewRequest()
        ...
        mReviewRepository.rateReview(request, object :
            WebserviceCallback<ApiResponseData<BaseResponse<JSONObject>>> {
            override fun onWebResponse(data: ApiResponseData<BaseResponse<JSONObject>>) {
                updateProgress(false)
                updateProgress(false)
