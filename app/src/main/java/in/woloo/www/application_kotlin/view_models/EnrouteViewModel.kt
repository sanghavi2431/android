...
class EnrouteViewModel : BaseViewModel() {
    ...
    private val mGetEnrouteNearbyWoloos: EventLiveData<BaseResponse<ArrayList<NearByStoreResponse.Data>>> = EventLiveData()
        ...
        enrouteRepository.getEnrouteWoloo(request, object :
            ...
            override fun onWebResponse(data: ApiResponseData<BaseResponse<ArrayList<NearByStoreResponse.Data>>>) {
                ...
                if (data.status == ApiResponseData.API_SUCCESS) {
                    mGetEnrouteNearbyWoloos.value = data.data
                } else {
                    mGetEnrouteNearbyWoloos.value = data.data
    ...
    fun observeEnrouteNearByWoloo(): EventLiveData<BaseResponse<ArrayList<NearByStoreResponse.Data>>> {
        return mGetEnrouteNearbyWoloos
    }
