...
class NearestWalkAdapter(
    ...
    private  var scrollViewModel: ScrollListViewModel? ,
    ...
    fun updateSearchLocation(location: String) {
        ...
        Log.d("Search Location init adapter", searchLocation)
     ...
     /*   @JvmField
        ...
        fun setData(nearByStore: NearByStoreResponse.Data, context: Context) {
            try {
                ...
                Log.d("Aarati Lat Lng" ,nearByStore.lat + " " + nearByStore.lng)
                try {
               ...
               /* if (nearByStore.cibilScore == "0" || nearByStore.cibilScoreColour.isEmpty()) {
                ...
                tv_direction!!.setOnClickListener {
                    ...
                    Log.d("Aarati Lat Lng" ,nearByStore.lat + " " + nearByStore.lng)
                        ...
                        Log.d("Search Location call", searchLocation)
        ...
        fun bindButtons() {
            ...
            tv2Km!!.setOnClickListener {
                Log.d("CLICKED" , "tv2Km")
                    ...
                    scrollViewModel!!.setScrollIndex(-1)
                    scrollViewModel!!.setScrollIndexForMarker(-1)
                sharedViewModel.setDistanceRange(2)
            ...
            tv4Km!!.setOnClickListener {
                try{
                    ...
                    scrollViewModel!!.setScrollIndex(-1)
                    scrollViewModel!!.setScrollIndexForMarker(-1)
                sharedViewModel.setDistanceRange(4)
            ...
            tv5Km!!.setOnClickListener {
                try{
                    ...
                    scrollViewModel!!.setScrollIndex(-1)
                    scrollViewModel!!.setScrollIndexForMarker(-1)
                    sharedViewModel.setDistanceRange(5)
            ...
            tv6Km!!.setOnClickListener {
                try{
                    ...
                    scrollViewModel!!.setScrollIndex(-1)
                    scrollViewModel!!.setScrollIndexForMarker(-1)
                sharedViewModel.setDistanceRange(6)
                }
                catch (e : Exception)
                {
                    e.printStackTrace()
            ...
            tv8km!!.setOnClickListener {
                try{
                    ...
                    scrollViewModel!!.setScrollIndex(-1)
                    scrollViewModel!!.setScrollIndexForMarker(-1)
                sharedViewModel.setDistanceRange(8)
                }
                catch (e : Exception)
                {
                    e.printStackTrace()
            ...
            tv10km!!.setOnClickListener {
                try{
                    ...
                    scrollViewModel!!.setScrollIndex(-1)
                    scrollViewModel!!.setScrollIndexForMarker(-1)
                sharedViewModel.setDistanceRange(10)
                }
                catch (e : Exception)
                {
                    e.printStackTrace()
            ...
            tv25Km!!.setOnClickListener {
                try {
                    ...
                    scrollViewModel!!.setScrollIndex(-1)
                    scrollViewModel!!.setScrollIndexForMarker(-1)
                sharedViewModel.setDistanceRange(25)
                }
                catch (e : Exception)
                {
                    e.printStackTrace()
