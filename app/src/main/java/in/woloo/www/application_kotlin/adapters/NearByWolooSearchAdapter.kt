...
class NearByWolooSearchAdapter(
    context: Context,
    private val storeList: List<NearByStoreResponse.Data>
) : ArrayAdapter<NearByStoreResponse.Data>(context, 0, storeList) {
    ...
    private fun createBindingView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        store?.let {
            ...
            binding.bottomHostLimit.visibility = View.GONE
