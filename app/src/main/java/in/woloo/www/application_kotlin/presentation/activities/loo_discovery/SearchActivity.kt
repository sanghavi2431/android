...
//        fragment_map = supportFragmentManager.findFragmentById(R.id.fragment_map)
    ...
    private fun initViews() {
        ...
        tv5Km = findViewById(R.id.tv_5km)
     ...
     /*   adapter = NearestWalkAdapter(this, nearByStoreResponseList , wolooViewModel , scrollViewModel = null)
        wolooRv?.setHasFixedSize(true)
        wolooRv?.layoutManager =  LinearLayoutManager(
    ...
    private fun setLiveData() {
        ...
        wolooViewModel?.observeAddCoinstoWolooUser()
            ?.observe(this) { response ->
               ...
               // showSuccessDialog(AppConstants.TAKE_ME_HERE_CLICK)
            }
