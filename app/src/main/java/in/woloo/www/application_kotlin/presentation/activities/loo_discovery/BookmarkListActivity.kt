...
class BookmarkListActivity : AppCompatActivity() {
    ...
    private lateinit  var sharedViewModelBookmark: SharedViewModelStringBookMark
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        sharedViewModelBookmark = ViewModelProvider(this)[SharedViewModelStringBookMark::class.java]
        ...
        searchLocation = customeIntent.getStringExtra(AppConstants.searchLocationToHost).toString()
        initView()
        binding.ivBack.setOnClickListener {
            finish()
        }

        sharedViewModelBookmark.sharedString.observe(this) { value ->
    ...
    {
        myHistoryAdapter = BookmarkListAdapter(applicationContext, bookmarkedWolooList , searchLocation)
...
class SharedViewModelStringBookMark : ViewModel() {
