...
class HomeDetailsActivity : AppCompatActivity() {
    ...
    private var searchedLoc : String = ""
    ...
    private fun initViews() {
        ...
        try {
            ...
            searchedLoc = intent.getStringExtra(AppConstants.searchLocationToHost).toString()
            loadFragment(HomeDetailsFragment.newInstance(fromSearch , searchedLoc))
        } catch (ex: Exception) {
