...
class WishlistCustomeAdapter(private val context: Activity ,
                             private var productList: ArrayList<ProductListData> ,
                             private val storeViewModel: StoreViewModel) : RecyclerView.Adapter<WishlistCustomeAdapter.ViewHolder>() {
