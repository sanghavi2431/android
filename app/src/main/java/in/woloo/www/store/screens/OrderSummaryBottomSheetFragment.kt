...
class OrderSummaryBottomSheetFragment : BottomSheetDialogFragment() {
    ...
    fun showSuccessDialog()
    {
        try {
            ...
            orderStatus.setOnClickListener { v: View? ->
                ...
                startActivity(
                    Intent(
                        this@OrderSummaryBottomSheetFragment.activity as ShoppingCartActivity?,
                        ShopOrderDetailsActivity::class.java
                    )
                )
                (this@OrderSummaryBottomSheetFragment.activity as ShoppingCartActivity).finish()
                alertDialog.dismiss()
            }
            alertDialog.show()
        } catch (ex: Exception) {
    ...
    companion object {
        fun newInstance(orderset: OrderSetResponse): OrderSummaryBottomSheetFragment {
            val fragment = OrderSummaryBottomSheetFragment()
            val args = Bundle()
