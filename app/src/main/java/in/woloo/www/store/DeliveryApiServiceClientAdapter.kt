...
class DeliveryApiServiceClientAdapter {
...
//        Netcore Disabled Log
        ...
        val retrofit = Retrofit.Builder()
            ...
            .baseUrl(BuildConfig.DELIVERY_URL)
            .build()
...
//            request.addHeader("content-type", "application/json")
            ...
            request.addHeader("Authorization", "Token 427fac3f9e72dae810b631fcaa481f9f29ff65ee")
            //  }
    ...
    companion object {
        ...
        private var mApiServiceClientAdapter: DeliveryApiServiceClientAdapter? = null
        private lateinit var mOkHttpClient: OkHttpClient.Builder
        val instance: DeliveryApiServiceClientAdapter
            get() {
                if (mApiServiceClientAdapter == null) {
                    mApiServiceClientAdapter = DeliveryApiServiceClientAdapter()
                }
