...
class OrderDetailsCustomAdapter (private val context: Activity,
                                 private var orderDetailsList: ArrayList<ItemsListDataOrderSet>,) : RecyclerView.Adapter<OrderDetailsCustomAdapter.ViewHolder>() {
