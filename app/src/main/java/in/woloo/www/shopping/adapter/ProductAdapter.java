...
public class ProductAdapter extends ArrayAdapter {
    ...
    public ProductAdapter(Context context, int layoutResourceId, ArrayList data) {
    ...
    public View getView(int position, final View convertView, ViewGroup parent) {
        ...
        String imageUri = Config.hostname + "../images/" + item.getImage();
              ...
              holder.mainLinearLayout.setOnClickListener(new View.OnClickListener() {
                  ...
                  public void onClick(View view) {
                      ...
                      try{
                          ...
                          bundle.putString("product_name",item.getTitle());
                          bundle.putString("pincode", ShoppingFragment.pincode);
                          Utility.logFirebaseEvent(((WolooDashboard)context), bundle, "shopping_view_product");


                          ProductDetailsFragment myFragment = new ProductDetailsFragment();
                          Bundle b = new Bundle();
                          b.putString("proId",item.getId());
                          b.putString("proName",item.getTitle());
                          b.putString("proPrice",item.getPrice());
                          b.putString("proDesc",item.getDesc());
