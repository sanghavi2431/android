...
public class DashboardCategoryAdapterTop extends RecyclerView.Adapter<DashboardCategoryAdapterTop.MyViewHolder> {
    ...
    public DashboardCategoryAdapterTop(List<CategoryModel> workList) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        Picasso.get().load(Config.hostname+"../images/"+work.getImage()).into(holder.image);
