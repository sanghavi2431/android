...
class SubscriptionViewModel : BaseViewModel() {
    ...
    fun initSubscriptionByOrder(request : InitSubscriptionRequest){
        ...
        updateProgress(true)
        subscriptionRepository.initSubscriptionByOrder(request, object : WebserviceCallback<ApiResponseData<BaseResponse<InitSubscriptionResponse.Data>>>{
    ...
    fun submitSubscriptionPurchase(request : SubmitSubscriptionPurchaseRequest){
        updateProgress(true)
        subscriptionRepository.submitSubscriptionPurchase(request, object : WebserviceCallback<ApiResponseData<BaseResponse<InitSubscriptionResponse>>>{
