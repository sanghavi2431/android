package `in`.woloo.www.v2.search
...
//        fragment_map = supportFragmentManager.findFragmentById(R.id.fragment_map)
    ...
    override fun onResume() {
        ...
        try {
            if (WolooApplication.getInstance().nearByWoloo != null && WolooApplication.getInstance().updatedLikeStatus != -1) {
                ...
                WolooApplication.getInstance().nearByWoloo = null
