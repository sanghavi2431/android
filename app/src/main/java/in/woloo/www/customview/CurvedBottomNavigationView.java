package in.woloo.www.customview;
...
public class CurvedBottomNavigationView extends BottomNavigationView {
    ...
    private  int CURVE_CIRCLE_RADIUS = 0;
    private final int CIRCLE_RADIUS = 256;
    ...
    private void init() {
        CURVE_CIRCLE_RADIUS=CIRCLE_RADIUS/getContext().getResources().getInteger(R.integer.curve_radius);
        mPath = new Path();
        mPaint = new Paint();
        mPaint.setStyle(Paint.Style.FILL_AND_STROKE);
        mPaint.setColor(Color.parseColor("#FEE22C"));
