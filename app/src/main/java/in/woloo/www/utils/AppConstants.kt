...
object AppConstants {
    ...
    const val MANUAL_CREDITS: String = "Manual Credit"
    ...
    const val PAYPERUSE: String = "PAYPERUSE"
    const val WOLOO_ID_Pay: String = "wolooid"

    const val DEFAULT_ZOOM: Int = 14
    ...
    const val SAY_IT_WOLOO: String = "WOLOO"
    const val SAY_IT_OCCASION: String = "240000005"
    const val SAY_IT_CUSTOM_OCCASION: String = "no_custom_message"
    ...
    const val SERVICE_CLICK: String = "service_click"
    const val RATE_CLICK: String = "rate_click"
    ...
    const val SAY_IT_WITH_WOLOO_CLICK: String = "say_it_with_woloo_click"
    const val RATE_A_TOILET_CLICK: String = "rate_a_toilet_click"
    const val MENU_DISCRIPTION_AFTER_OVERLAY: String = "menu_description_after_overlay"
    const val MENU_CLICK : String = "menu_click"
    const val POWDER_ROOM_OFFER : String = "powder_room_offer"
    ...
    const val WOLOO_TYPE_HOST: String = "Woloo Host"
    const val WOLOO_TYPE_POWDER_ROOM: String = "Powder Room"
    ...
    const val FROM_CATEGORIES: String = "from_filter_categories"

    const val FROM_FILTER_CATEGORIES: String = "from_categories"

    const val FROM_TOP_BRANDS: String = "from_top_brands"

    const val FROM_SEARCH_PRODUCT :String = "from_search"

    const val TO_WISHLIST :String = "to_wishlist"

    const val FROM_COLLECTIONS_SEE_MORE :String = "from_collections_see_more"

    const val FROM_PERIOD_CATEGORY :String = "from_period_category"

    const val SECRETEKEYCRYPTO :String = "12345678901234567890123456789012"

    const val FROMBLOGS :String = "from_blogs"


    const val USE :String = "Use"

    const val DONTUSE :String = "Don't Use"

    const val ON_NEW_SHOP_CLICK: String = "on_new_shop_click"

    const val RATE_TOILET_CLICK: String = "Rate_A_Toilet"
    const val HOST_DETAILS_CLICK: String = "View_Host_Details"
    const val TAKE_ME_HERE_CLICK: String = "Take_me_here"
    const val NO_WOLOO_FOUND_CLICK: String = "No_Woloo_Found"
    const val SET_PERIOD_TRACKER_CLICK: String = "Set_Period_tracker"
    const val SET_THIRST_REMINDER_CLICK: String = "Set_Thirst_Reminder"
    const val WOLOO_SUBSCRIPTION_POINTS_CLICK: String = "Woloo_Subscription_Points"

    const val CIBIL_ONE: String = "cibil_one"
    const val CIBIL_TWO: String = "cibil_two"
    const val CIBIL_THREE: String = "cibil_three"
    const val CIBIL_FOUR: String = "cibil_four"
    const val CIBIL_FIVE: String = "cibil_five"

    const val timeToHost: String = "TIME_TO_HOST"
    const val distanceToHost: String = "DISTANCE_TO_HOST"
    const val searchLocationToHost: String = "SEARCH_LOCATION_TO_HOST"
    const val currentLocationToHost: String = "CURRENT_LOCATION_TO_HOST"
