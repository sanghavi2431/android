          ...
          //  String query="select * from " + TABLE_NAME + " WHERE " + COL_NOTIFICATION_USER_ID + " = " + userMobile + "";
            ...
            if (c.moveToFirst()) {
                do {
                    ...
                    notificationBean.title = c.getString(c.getColumnIndex(COL_NOTIFICATION_TITLE));
                    notificationBean.description = c.getString(c.getColumnIndex(COL_NOTIFICATION_DESCRIPTION));
                    notificationBean.category = c.getString(c.getColumnIndex(COL_NOTIFICATION_CATEGORY));
                    notificationBean.date = c.getString(c.getColumnIndex(COL_NOTIFICATION_DATE));
                    notificationBean.notificationImageUrl = c.getString(c.getColumnIndex(COL_NOTIFICATION_IMAGE_URL));
                    notificationBean.landingUrl = c.getString(c.getColumnIndex(COL_NOTIFICATION_LANDING_URL));
                    notificationBean.read = c.getString(c.getColumnIndex(COL_NOTIFICATION_READ));
